...
// });
    ...
    //nav的js
    var nav_bs = document.getElementsByClassName('nav_bs');
    for (var s =0; s<nav_bs.length;s++){
        // alert(nav_bs.length);
        nav_bs[s.index]=s;
        nav_bs[s].addEventListener('mouseover',oChanpingreen);
        nav_bs[s].addEventListener('mouseout',oChanpinhuise);
    }
